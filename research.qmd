...
Our research focuses primarily on amphibians, as 41% of all amphibians are threatened with extinction. Using laboratory experiments, field-based approaches, and ecological manipulations, we aim to understand how organisms respond to rapidly changing environments.
...
<figcaption>
Adult gray treefrog (*Hyla versicolor*) on leaf. 
</figcaption>
...
## Amphibian Monitoring and Habitat Use

Tracking how populations change across time is essential to identifying potential threats to different species, which informs their conservation. Through field-based monitoring and surveying, we examine how amphibians use and select habitats across changing environmental conditions. By linking patterns of abundance and distribution with factors like water availability, vegetation, temperature, and human disturbance, we can better determine conditions that support or prevent the persistence of amphibians in varying habitats. 

Students in the Neptune Lab have the opportunity to assist with local amphibian monitoring by collecting observational data in the field. Examples of this type of sampling include visual surveys of amphibian egg deposition and standardized adult surveys via structures such as pipe refugia. 
...
<img src="images/gray-pipe.jpg">

<figcaption>
Adult gray treefrog (*Hyla versicolor*) inside a pipe refugia.
</figcaption>
